...
public class CircleGradienterActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_circle_gradienter);
    ...
    private void onAngleChanged(float rollAngle, float pitchAngle, float azimuth){
        ...
        tvVert.setText(String.valueOf((int)Math.toDegrees(pitchAngle)) + "°");//+String.valueOf((int)Math.toDegrees(azimuth)) + "°"
    }
}
